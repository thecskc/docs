...
- Simply re-run the affected Test Flow. Jina automatically adjusts and generates a new Test Flow version tailored to your updated app.
...
import { useJinaFlowDiagram } from "/snippets/flow-diagram.mdx"
<useJinaFlowDiagram/>