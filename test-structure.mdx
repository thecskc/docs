...
The specificity of your prompt affects how many flows Jina generates and what steps they include. But **each test flow version always executes deterministically**.
